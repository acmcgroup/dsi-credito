    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center text-white pt-20 pb-8">
        <div className="max-w-4xl  mx-auto mt-30">
          ...
          {/* Features */}
          <div className="flex flex-row sm:flex-row justify-center gap-4 sm:gap-6 mb-8 sm:mb-12 px-4 sm:px-0">
            <div className="flex items-center justify-center gap-2">
              <Award className="h-4 w-4 text-yellow-400 flex-shrink-0" />
              <span className="text-sm font-medium">Exclusividade</span>
            </div>
            <div className="flex items-center justify-center gap-2">
              <Clock className="h-4 w-4 text-green-400 flex-shrink-0" />
              <span className="text-sm font-medium">Rapidez</span>
            </div>
            <div className="flex items-center justify-center gap-2">
          ...
          {/* CTA Buttons */}
          <div className="flex flex-row sm:flex-row gap-3 sm:gap-4 justify-center items-center mb-12 sm:mb-16 px-4 sm:px-0">
            <Button variant="hero" size="lg" className="group w-full sm:w-auto bg-blue-600/70 hover:bg-blue-600/90 transition-all duration-300">
          ...
          {/* Stats */}
          <div className="flex flex-row sm:flex-row justify-center gap-6 sm:gap-8 pt-6 border-t border-white/20 mb-8">
